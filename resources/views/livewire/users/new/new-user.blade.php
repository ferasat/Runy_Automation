    ...
    <div class="col-xl-8 order-xl-1">
        <div class="card bg-secondary shadow">
                    ...
                    <div class="pl-lg-4">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                            <label class="form-control-label"
                                   for="input-current-password">{{ __('Password') }}</label>
                            <input type="password" wire:model.lazy="password" id="input-current-password"
                                   class="form-control form-control-alternative{{ $errors->has('password') ? ' is-invalid' : '' }}" required>
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-success mt-4" wir:click.privent="newuser()">Save</button>
                        </div>
                    </div>
                </div>
                <hr class="my-4"/>
            ...
            <div class="card-footer">
                <div class="btn btn-success" wire:click.privent="newuser()">Save</div>
            </div>
        </div>
    </div>
</div>
