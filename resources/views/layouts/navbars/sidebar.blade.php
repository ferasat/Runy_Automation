    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                @if(Auth::user()->levelPermission > 8)
                <li class="nav-item">
                ...
                @endif
                <li class="nav-item">
                    <a class="nav-link " href="#navbar-Requests" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-Requests">
                    ...
                    <div class="collapse " id="navbar-Requests">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('corrections.index') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                      ...
                      <span class="nav-link-text">Mailroom</span>
                    </a>
                </li>
